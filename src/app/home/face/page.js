"use client"; // Pastikan kode ini berjalan di client-side
...
export default function Upload() {
    ...
    const handleFileChange = async (e) => {
        ...
        setCustomUser(user);
        setSelected(user);
        setErrorMessage(null); // Clear error message when successful
    };

    const handleContinue = () => {
        router.push("/home/face/compare", { query: { account: JSON.stringify(selected) } });
    };
